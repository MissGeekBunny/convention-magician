...
add_action( 'tgmpa_register', 'convention_magician_register_js_composer_plugins' );
/**
 ...
 */
function convention_magician_register_js_composer_plugins() {
    /**
    ...
    $theme_text_domain = 'convention-magician';
