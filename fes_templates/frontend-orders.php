				...
				<div class="vendor-order-details">
					<div class="vendor-order-info-group">
						<span class="vendor-order-label">
							<?php echo _x( 'Price', 'FES vendor dashboard Order display', 'convention-magician' ) . ': '; ?>
						</span>
					...
					<div class="vendor-order-info-group">
						<span class="vendor-order-label">
							<?php echo _x( 'Customer', 'FES vendor dashboard Order display', 'convention-magician' ) . ': '; ?>
						</span>
					...
					<div class="vendor-order-info-group">
						<span class="vendor-order-label">
							<?php echo _x( 'Details', 'FES vendor dashboard Order display', 'convention-magician' ) . ': '; ?>
						</span>
