...
if ( count( $products ) > 0 ) {
				...
				<div class="vendor-product-details">
					<div class="vendor-product-info-group">
						<span class="vendor-product-label">
							<?php echo _x( 'Price', 'FES vendor dashboard Product display', 'convention-magician' ) . ': '; ?>
						</span>
					...
					<div class="vendor-product-info-group">
						<span class="vendor-product-label">
							<?php echo _x( 'Purchases', 'FES vendor dashboard Product display', 'convention-magician' ) . ': '; ?>
						</span>
					...
					<div class="vendor-product-info-group">
						<span class="vendor-product-label">
							<?php echo _x( 'Details', 'FES vendor dashboard Product display', 'convention-magician' ) . ': '; ?>
						</span>
	...
	_e( 'No items found','convention-magician' );
}
